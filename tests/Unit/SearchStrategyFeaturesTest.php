...
class SearchStrategyFeaturesTest extends TestCase
{
    ...
    public function test_throws_error_when_calling_find_all_with_strategies_without_search_service(): void
    {
    ...
    public function test_does_not_throw_error_when_calling_find_all_without_strategies(): void
    {
        // Create a service without SearchService
        $serviceWithoutSearch = new class(new User) extends BaseReaderService
        {
